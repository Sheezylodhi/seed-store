...
export default function LoginForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      /*
       * The session is stored in an httpOnly cookie by the API.
       * The client never receives or stores the session token.
       */
        ...
        <section className="relative hidden overflow-hidden bg-[#10291d] lg:flex">
          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-[590px]">
              ...
              >
                Sign in to manage your orders, explore premium
                seeds, and keep your growing journey moving forward.
              </motion.p>
          ...
          <div className="w-full max-w-[440px]">
            ...
            >
              ...
              <p className="mt-4 text-[14px] leading-6 text-[#718077]">
                Access your orders, account details, and everything
                you need for your next grow.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="mt-6 flex items-start gap-3 rounded-2xl border border-[#e3e9e1] bg-[#f3f6f1] px-4 py-3.5">
                ...
                <p className="text-[11px] leading-5 text-[#68766e]">
                  ...
                  httpOnly session. Your password is never stored
                  in plain text.
                </p>
              </div>
